...
| ELO-098 | Correções de UX/UI e revisão pt-BR | Given formulários e mensagens do PWA/Admin, When ajustar placeholders, headers, dark mode e microcopy, Then a experiência fica consistente em pt-BR e sem ruídos visuais | Must | 11 | 5 |
| ELO-099 | Localização BR e validação de WhatsApp | Given formulários com UF/cidade e WhatsApp, When integrar lista dependente de cidades por UF e máscara/validação BR, Then os dados ficam consistentes em todos os fluxos de cadastro e edição | Must | 12 | 8 |
