    ...
    <MemberShell>
      <div className={styles.page}>
        ...
        <section className={styles.hero}>
          ...
          <h2 className={styles.title}>O Nexo</h2>
          <p className={styles.description}>Conecte-se com a elite do seu ecossistema e transforme descoberta em relacionamento.</p>
        </section>
